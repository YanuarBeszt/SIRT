...
<div class="row">
    ...
    <div class="card shadow mb-4 col-12">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url() . 'Warga/PembuatanSurat/printLainnya/' . $uri; ?>" method="post" target="_blank">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control" name="ket" id="ket" value="-" required>
