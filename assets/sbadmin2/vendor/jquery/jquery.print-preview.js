...
(function($) {
  ...
  $.printPreview = {
    loadPrintPreview: function() {
      ...
      print_controls = $(
        '<div id="print-modal-controls">' +
          ...
          '<a href="#" class="close" title="Tutup tampilan cetak">Close</a>'
      ).hide();
      var print_frame = $(
      ...
      if (!$.browser.msie && !($.browser.version < 7)) {
        ...
        $("head link[media*=print], head link[media=all]").each(function() {
          $("head", print_frame_ref).append(
            $(this)
              .clone()
              .attr("media", "all")[0].outerHTML
          );
        });
      }
    ...
    distroyPrintPreview: function() {
      ...
      print_modal.animate(
        { top: $(window).scrollTop() - $(window).height(), opacity: 1 },
        400,
        "linear",
        function() {
          print_modal.remove();
